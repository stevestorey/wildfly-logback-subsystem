...
public class SubsystemParsingTestCase extends AbstractSubsystemTest {
    ...
    public void testParseSubsystem() throws Exception {
        ...
        String subsystemXml =
                "<subsystem xmlns=\"" + LogbackExtension.NAMESPACE + "\">" +
                        "</subsystem>";
        ...
        Assert.assertEquals(LogbackExtension.SUBSYSTEM_NAME, element.getValue());
    }
    ...
    public void testInstallIntoController() throws Exception {
        ...
        Assert.assertTrue(model.get(SUBSYSTEM).hasDefined(LogbackExtension.SUBSYSTEM_NAME));
    }
